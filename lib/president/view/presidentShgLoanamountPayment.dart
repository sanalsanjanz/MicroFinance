...
class PresidentShgAmountPayment extends StatefulWidget {
  const PresidentShgAmountPayment(
      /* {required this.unitid, required this.memberid} */);
  // String unitid;
  // String memberid;
  @override
  State<PresidentShgAmountPayment> createState() =>
      _PresidentShgAmountPaymentState();
}

class _PresidentShgAmountPaymentState extends State<PresidentShgAmountPayment> {
  @override
  void initState() {
    super.initState();
