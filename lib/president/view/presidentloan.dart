...
class PresidentLoan extends StatelessWidget {
  PresidentLoan({Key? key}) : super(key: key);
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: TextField(
                                    onChanged: (value) => val.setloanamt(value),
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: TextField(
                                    onChanged: (value) => val.setperiod(value),
                                    decoration: const InputDecoration(
                                        suffix: Text('/months')),
                                  ))
                                ],
                              ...
                              Row(
                                children: [
                                  ...
                                  Expanded(
                                      child: TextField(
                                    onChanged: (value) => val.setpaydate(value),
                                    decoration: const InputDecoration(
                                        hintText: '(1-31)'),
                                  ))
                                ],
                              ...
                              CupertinoButton(
                                  ...
                                  onPressed: () {
                                    val.giveShreyasloan(data['memberid'],
                                        data['membername'], context);
                                  })
                            ],
                          ),
                        ),
