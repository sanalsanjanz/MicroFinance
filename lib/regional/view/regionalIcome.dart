...
class RegionalIncome extends StatefulWidget {
  const RegionalIncome({super.key});

  @override
  State<RegionalIncome> createState() => _RegionalIncomeState();
}

class _RegionalIncomeState extends State<RegionalIncome> {
  @override
  void initState() {
    super.initState();
