...
class UnitIndLoanBorrowersData extends StatefulWidget {
  // String unitid;
  UnitIndLoanBorrowersData({required this.passbookno});
  String passbookno;

  @override
  State<UnitIndLoanBorrowersData> createState() =>
      _UnitIndLoanBorrowersDataState();
}

class _UnitIndLoanBorrowersDataState extends State<UnitIndLoanBorrowersData> {
      ...
      body: Consumer<UnitControll>(
        builder: (context, value, child) {
          return FutureBuilder(
            future:
                value.closeUnitLoantoIndividuals(context, widget.passbookno),
                        ...
                        child: Card(
                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  data['member_name'].toString().toUpperCase(),
                                  style: title,
                                ),
                                space,
                                Items(
                                    value: data['ldate'], titile: 'Loan Date'),
                                space,
                                Items(
                                    titile: 'Loan Amount',
                                    value: data['amount']),
                                ...
                                Items(
                                    ...
                                    titile: 'Loan Period'),
                                space,
                                const Items(value: '12 %', titile: 'Interest'),
                                space,
                                Items(
                                                        ...
                                                        Row(
                                                          ...
                                                          children: [
                                                            ...
                                                            TextButton(
                                                              onPressed:
                                                                  () async {
                                                                await value.payUnitIndividualLoan(
                                                                    data[
                                                                        'loanid'],
                                                                    context,
                                                                    amount.text,
