...
class MemberOveralReport extends StatefulWidget {
  MemberOveralReport({required this.presid});
  String presid;
  @override
  State<MemberOveralReport> createState() => _MemberOveralReportState();
}

class _MemberOveralReportState extends State<MemberOveralReport> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar:
          AppBar(title: const Text("Report"), backgroundColor: memberPrimary),
      body: Column(
        children: [
