...
class AuthLinks {
  ...
  static var adminUpdatePassword = Uri.parse('${baseUrl}Admin/changepassword');
  static var adminChangeProfit =
      Uri.parse('${baseUrl}Admin/changeregionprofit');
  static var adminGetRegionalProfit = Uri.parse('${baseUrl}Admin/regionprofit');
  ...
  static var adminTransferInsurance =
      Uri.parse('${baseUrl}Admin/transferinsurance');
  static var adminAddInsurance = Uri.parse('${baseUrl}Admin/insurance');
  static var adminAddAccountingHead =
      Uri.parse('${baseUrl}Admin/addaccountinghead');
  static var adminAddUnit = Uri.parse('${baseUrl}Admin/addunit');
  static var adminAddRegional = Uri.parse('${baseUrl}Admin/addregion');
  static var adminAddExpense = Uri.parse('${baseUrl}Admin/addexpense');
  static var adminAddIncome = Uri.parse('${baseUrl}Admin/addotherincome');
  static var adminGetAccountingHead =
      Uri.parse('${baseUrl}Admin/getaccountinghead');
