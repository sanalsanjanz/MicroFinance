...
class AdminAddAccountingHead extends StatefulWidget {
  const AdminAddAccountingHead({super.key});

  @override
  State<AdminAddAccountingHead> createState() => _AdminAddAccountingHeadState();
}

class _AdminAddAccountingHeadState extends State<AdminAddAccountingHead> {
  bool income = false;
  bool expense = false;
                ...
                return FutureBuilder(
                  ...
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      return Center(
                        child: SpinKitFadingCircle(color: shadeAdminColor),
                      );
                    }
                  },
                );
